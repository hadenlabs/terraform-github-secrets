...
<!-- Title: Contributing GithubFlow TerraformGithubSecrets -->
...
To contribute to terraform-github-secrets project on [GitHub](https://github.com/hadenlabs/terraform-github-secrets), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/terraform-github-secrets/pulls).
...
To follow the instructions in this guide and start contributing to terraform-github-secrets project on GitHub:
